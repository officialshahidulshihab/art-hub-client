    ...
    <main className="mx-auto grid max-w-6xl grid-cols-1 gap-6 px-18 py-16 lg:grid-cols-2">
      <div>
        ...
        <p className="mt-5 max-w-sm text-sm text-muted-foreground">
          Sign in to view your purchases, manage your wishlist, and pick up
          where you left off in the gallery.
        </p>
        <div className="relative mt-10 aspect-square w-full max-w-md overflow-hidden">
          <Image
            src="https://i.ibb.co.com/qMy0MWsM/signin.avif"
      ...
      <div className="w-full max-w-md justify-self-start lg:justify-self-end mt-20">
